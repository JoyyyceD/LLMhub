        ...
        <div className="flex justify-between h-20 items-center">
          <div className="flex items-center gap-4 md:gap-12">
            <Link to="/" className="flex items-center gap-2.5 group">
              <div className="!bg-white border border-slate-300 p-2 rounded-xl shadow-lg shadow-primary/20 group-hover:scale-110 transition-transform">
                <img src="/favicon.svg" alt="Token Galaxy logo" className="w-8 h-8 object-contain block" />
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="!bg-white border border-slate-300 p-1.5 rounded-lg shadow-lg shadow-primary/15">
                <img src="/favicon.svg" alt="Token Galaxy logo" className="w-8 h-8 object-contain block" />
              </div>
