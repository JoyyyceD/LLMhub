  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-4">开发者资源中心</h1>
        ...
        <section id="benchmarks" className="scroll-mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white border border-slate-200 rounded-2xl p-6 hover:border-primary/30 transition-colors">
                <span className="text-[10px] font-semibold text-primary tracking-wide bg-primary/5 px-2 py-1 rounded mb-4 inline-block">{item.score}</span>
        ...
        <section id="status" className="scroll-mt-24">
          ...
          <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden">
            <div className="px-6 py-4 bg-slate-50 border-b border-slate-200 flex justify-between items-center">
              <span className="text-xs font-semibold text-slate-500">实时监控 (每 60s 更新)</span>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse"></div>
                <span className="text-xs font-semibold text-emerald-500 tracking-wide">所有服务正常</span>
              </div>
            </div>
              ...
              {[
                ...
                <div key={i} className="px-6 py-4 flex items-center justify-between hover:bg-slate-50 transition-colors">
                  <div className="flex items-center gap-4">
                    <span className="font-semibold text-sm">{item.vendor}</span>
...
print(response.choices[0].message.content)`}
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="p-5 bg-white border border-slate-200 rounded-2xl flex items-center justify-between group hover:border-primary transition-colors cursor-pointer">
                  <div>
